(() => {
  ...
  function renderHome() {
    ...
    const homeLabDetails = {
      seasons: ["🌸", "季節と生き物LAB", "気温と生き物"],
      body: ["💪", "人の体LAB", "筋肉と関節"],
      weather: ["🌤️", "天気LAB", "天気と気温"],
      rainwater: ["🌧️", "雨水LAB", "流れ方としみこみ"],
      moonstars: ["🌙", "月と星LAB", "位置と見える形"],
      electricity: ["⚡", "電気LAB", "電池とモーター"],
      airwater: ["💨", "空気と水LAB", "縮み方の違い"],
      volume: ["🌡️", "体積LAB", "温度と体積"],
      heating: ["🔥", "あたたまりLAB", "熱の伝わり方"],
      waterstate: ["🧊", "水のすがたLAB", "温度と姿"]
    };
    ...
    app.innerHTML = `
      <section class="home-dashboard">
        <header class="home-dashboard-head">
          <div><p class="eyebrow">小学4年生 理科</p><h1>理科ラボ 4</h1><p>動かして確かめる。問題で整理する。</p></div>
  ...
  function renderReviewResult() {
    ...
    app.innerHTML = `<article class="activity-card review-card review-result">
      ...
      <p>${reviewState.misses.length ? "確かめたい単元へ戻って、証拠と説明をもう一度つなげよう。" : "10単元の関係・予想・理由がしっかりつながっています。"}</p>
  ...
  document.querySelector("#resetButton").addEventListener("click", () => {
    ...
    data = defaultData();
    save();
    localStorage.removeItem("rikaLab4.notebook.v1");
